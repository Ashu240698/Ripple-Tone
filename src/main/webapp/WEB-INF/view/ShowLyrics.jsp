...
<title>${music.musicName}-Lyrics</title>
</head>
</head>
...
<body>
	...
	<!--	<sec:authorize access="hasRole('ROLE_ADMIN')">	-->
		<c:if test="${!empty music.lyrics}">
			<div id="editlyrics"> 
				<form action="EditLyricsPage">
					<button class="btn btn-primary active btn-ms"><b>Edit Lyrics</b></button>
				</form>
			</div>
		</c:if>
		...
		<c:if test="${!empty music.lyrics}">
			<div id="delete"> 
				<form action="deleteLyrics">
					<button class="btn btn-primary active btn-ms"><b>Delete Lyrics</b></button>
				</form>
			</div>
		</c:if>
	<!--	</sec:authorize>	-->
