...
<body>
	...
	<ul>
		<li> <h2 style="color: silver; padding: 10px">RippleTone</h2> </li>
...
<h1 align="center">User Home</h1>
		<h1 align="center" class="adminName">Welcome: ${userName} </h1>  
		<div class="d-flex justify-content-center space">
			<a href="music"><button type="button" class="btn btn-info  space1">See Song List</button></a>
		</div>
