...
body {
	...
	background-image: url("https://www.xmple.com/wallpaper/gradient-red-linear-blue-3840x2160-c2-fb0628-6495ed-a-60-f-14.svg");
	min-height: 100vh;
}
						...
						<div class="card-body">
							...
							<form:form action="loginProcess" modelAttribute="user"
								...
								<div class="form-group">
									...
									<tr>
										<td>&nbsp;</td>
										<td class="error">${usernotfound}</td>
									</tr>
									</tr>
								...
								<div class="form-group mb-4">
									...
									<tr>
										<td>&nbsp;</td>
										<td class="error">${passwordwrong}</td>
									</tr>
							...
							<p class="login-card-footer-text">Don't have an account? <a href="signup" class="text-reset"><span class="text1">Signup here</span></a>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<i class="bi bi-arrow-left-circle-fill"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="40" fill="currentColor" class="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
 									<a href="welcome"> <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm3.5 7.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5z"/>
									</svg></i></a>
							</p>
						</div>
					</div>
