...
<body>
	...
	<nav class="navbar navbar-default">
		...
		<form:form action="edit" modelAttribute="musicObj" id="lyricsForm">
				<table>  
					<tr>
					...
					<tr id="txt">
						...
						<td><textarea name="lyrics" form="lyricsForm" rows="15" cols="100" placeholder="Max 5000 words allowed" required="required""></textarea></td>
						<td><form:errors path="musicName" cssClass="error" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="10"><form:button id="btn" name="Submit">Add Lyrics</form:button>
						</td>
					</tr>
				</table>
			</form:form>
